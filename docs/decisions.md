...
| [Money](decisions/money.md) | `M1`–`M12` | Seller of record, GST split, invoice numbering, revenue share, refunds |
...
| [Consent, retention and DPDP](decisions/dpdp.md) | `C1`–`C21` | Consent atomicity, purpose immutability, retention as data, breach clock, the analytics vocabulary |
...
| [Authorization fixes](decisions/authorization-fixes.md) | `AZ8`–`AZ29` | Fulfilment scope binding, public catalogue reads for signed-in users, the one derived owner, and who the back office admits at all |
