...
select (select id from school where is_active order by id limit 1)          as school_id,
       ...
       'a1000000-0000-0000-0000-0000000000f1'::uuid                         as offer_id,
       'a2000000-0000-0000-0000-0000000000f1'::uuid                         as pack_id,
       'a3000000-0000-0000-0000-0000000000f1'::uuid                         as buy_group_id;
...
select 'a4000000-0000-0000-0000-0000000000f1'::uuid as group_id,
       'a5000000-0000-0000-0000-0000000000f1'::uuid as order_id;
