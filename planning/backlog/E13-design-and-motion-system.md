...
- [ ] `E13-18` Correct `M01`'s allow/deny lists — it permits press feedback on *"the quantity stepper"* and then excludes *"anything under 32pt visually — a 28pt stepper button"*. `docs/design-tokens.md` §4.1 confirms the stepper draws at ~28pt; the deny list is the correct one
