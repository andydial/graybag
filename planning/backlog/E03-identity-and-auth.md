...
- [ ] `E03-19` Produce the two-account list for `E03-18` as a support artefact and build the merge-on-request path (user confirms, then histories combine) rather than a bulk merge at cutover
