...
- **Order alert emails** (2026-08-23) — `E08-16`. Built, deployed, and **sending nothing until Andy
  adds an address** at `/admin/alerts`; an empty recipient list is the configured state, not a bug.
